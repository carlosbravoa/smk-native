...
| S5 | `src/mode7.c` `sky_colour` | invented vertical gradient from palette entries 1-2 - the black void beyond the plane is ours, not the game's | BG2 backdrop / per-track horizon graphics, not yet located in ROM | P5 - **next** |
