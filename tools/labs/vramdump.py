...
open("assets/captures/vram%s.bin" % TAG,"wb").write(bytes(L.b.vram)); open("assets/captures/cgram%s.bin" % TAG,"wb").write(bytes(L.b.cgram)); open("assets/captures/oam%s.bin" % TAG,"wb").write(bytes(L.b.oam))
